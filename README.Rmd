...
```{r datasetsimulation1, eval = FALSE}
library(bigmemory)
library(bigPCAcpp)
...
```{r bigmemorytopcomponents, eval = FALSE}
library(bigmemory)
library(bigPCAcpp)
...
```{r bigalgebraexample, eval = FALSE}
library(bigmemory)
library(bigalgebra)
library(bigPCAcpp)

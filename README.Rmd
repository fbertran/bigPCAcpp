...
```{r datasetsimulation1, eval = TRUE}
library(bigmemory)
library(bigPCAcpp)
...
```{r bigmemorytopcomponents, eval = TRUE}
library(bigmemory)
library(bigPCAcpp)
